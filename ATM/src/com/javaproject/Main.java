										...
										switch(choice)
											{
												...
												case 2:
												{
													...
													stat.executeUpdate("update atm set balance="+balance1+ " where atm_pin="+in.getPin());
												...
												case 3:
												{
													...
													if(withdraw_ammount1 <= balance)
														...
														stat.executeUpdate("update atm set balance="+balance2+ " where atm_pin="+in.getPin());
												...
												case 5:
												{
													...
													if(pinn==pin && account_number==acc_no &&phone_number==PH_number )
														...
														int p=sc.nextInt();
														stat.executeUpdate("update atm set atm_pin="+p+" where atm_pin="+in.getPin());
	   ...
	   if(ch==2)
	   {
		   ...
		   switch(cho)
		   {
			   ...
			   case 2:
			   {
				   System.out.println("ENTER CUSTOMER ACCOUNT_NUMBER..............");
				   int ac=sc.nextInt();
				   stat.executeUpdate("DELETE FROM ATM WHERE ACCOUNT_NUMBER="+ac);
